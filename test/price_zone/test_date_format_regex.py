...
class TestDateRegex(unittest.TestCase):
    ...
    def test_date_format_regex_for_valid_format_1(self):
        ...
        data = [['022', '2020-08-06 00:00:00.000000']]
        schema = StructType([
