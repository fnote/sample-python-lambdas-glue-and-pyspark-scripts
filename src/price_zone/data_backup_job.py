...
if __name__ == "__main__":
    ...
    args = getResolvedOptions(sys.argv, ['s3_path',  'partitioned_files_path', 'decompressed_file_path', 'etl_timestamp', 'INTERMEDIATE_S3_BUCKET',
                                         'ARCHIVING_S3_BUCKET'])
    ...
    move_objects_with_prefix(intermediate_s3_bucket, partitioned_files_path, archiving_s3_bucket, archiving_path)
