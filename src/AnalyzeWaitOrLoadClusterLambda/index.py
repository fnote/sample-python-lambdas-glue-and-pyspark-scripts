...
CLUSTER_LOAD_JOB_COUNT_QUERY = 'SELECT MAX_LOAD_JOB_COUNT, RUNNING_LOAD_JOB_COUNT FROM PRICE_ZONE_CLUSTER_LOAD_JOB_SETTINGS WHERE CLUSTER_ID = {} FOR UPDATE'
...
JOB_COUNT_AFTER_UPDATE_QUERY = 'SELECT RUNNING_LOAD_JOB_COUNT FROM PRICE_ZONE_CLUSTER_LOAD_JOB_SETTINGS WHERE CLUSTER_ID={} FOR UPDATE'
